...
function content_filter($rc) {
	...
	if (preg_match($pattern0, $rc)) {
		...
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1301", "New Field Guide: Patronage Dividend - Presenting GM Recommendations");
		$this->Ln(7);	
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1304", "Featured Video: Co-op Cafe Roundups");
		$this->Ln(7);
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1195", "New Resource: Board Discipline Field Guide");
		$this->Ln(7);
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->Write(11,"And ");
		...
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1266", "Publicizing the Board to Owners and the Community");
		$this->Ln(4);
		$this->Cell(8);
		$this->SetFont('Arial','I',9);
		$this->Write(10,"November, 2013");
		$this->Ln(6);
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1267", "Great Idea: Sharing the Leadership Role");
		$this->Ln(4);
		$this->Cell(8);
		$this->SetFont('Arial','I',9);
		$this->Write(10,"November, 2013");
		...
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1303", "Announcements: In-person events");
		$this->Ln(4);
		$this->Cell(8);
		$this->SetFont('Arial','I',9);
		$this->Write(10,"December, 2013");$this->Ln(6);
		$this->SetFont('Arial','B',10);
		$this->Cell(8);
		$this->PutLink("http://cdsconsulting.coop/newsletter/article/1252", "Great Idea: Process for Replacing a Board Member");
		$this->Ln(4);
		$this->Cell(8);
		$this->SetFont('Arial','I',9);
		$this->Write(10,"October, 2013");
